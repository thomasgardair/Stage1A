...
table_contingence_orig  <- xtabs(nb_obs ~ REGION + SEX, data = tab_sans_marges)
table_contingence_pert  <- xtabs(nb_obs_pert ~ REGION + SEX, data = tab_sans_marges)

table_contingence_orig  <- xtabs(nb_obs ~ REGION + DIPL, data = tab_sans_marges)
table_contingence_pert  <- xtabs(nb_obs_pert ~ REGION + DIPL, data = tab_sans_marges)

table_contingence_orig  <- xtabs(nb_obs ~ AGE + SEX, data = tab_sans_marges)
table_contingence_pert  <- xtabs(nb_obs_pert ~ AGE + SEX, data = tab_sans_marges)

table_contingence_orig  <- xtabs(nb_obs ~ AGE + DIPL, data = tab_sans_marges)
table_contingence_pert  <- xtabs(nb_obs_pert ~ AGE + DIPL, data = tab_sans_marges)

table_contingence_orig  <- xtabs(nb_obs ~ DIPL + SEX, data = tab_sans_marges)
